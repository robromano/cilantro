    ...
    var StatModel = Model.extend({
        ...
        url: function() {
            if (!this.parent.id && this.parent.collection) {
                return this.parent.collection.links.self.uri;
            }
            else if (this.parent.links.stats && this.parent.links.stats.uri) {
                return this.parent.links.stats.uri;
            }
            else {
